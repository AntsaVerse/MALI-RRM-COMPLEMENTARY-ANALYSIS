...
date_periode_prec <- as.Date("2025-01-01")
date_periode_act <- as.Date("2025-12-31")
...
La période d'analyse va de 
<span style="color:red;">`r date_periode_prec`</span> 
à 
...
df_rrm_for_analysis_mois <-df_rrm%>%
  filter(date_fin_reponse>=date_periode_prec&date_fin_reponse<=date_periode_act)
